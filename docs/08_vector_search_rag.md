# Vector Search and RAG - Speech Analytics Lakehouse on Databricks (docs/08_vector_search_rag.md)
...
- `docs/08_vector_search_rag.md` (this document)
...
This guide explains the vector search and RAG design choices, retrieval options, run parameters, validation expectations, and troubleshooting guidance.
